...
type QueueSpec struct {
	...
	// SchedulingPolicy define the scheduling policy of queue
	// +optional
	SchedulingPolicy string `json:"schedulingPolicy,omitempty" protobuf:"bytes,11,opt,name=schedulingPolicy"`
}
