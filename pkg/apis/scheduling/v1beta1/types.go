...
type QueueStatus struct {
	...
	Reservation QueueReservation `json:"reservation,omitempty" protobuf:"bytes,7,opt,name=reservation"`
...
type ReservationSpec struct {
	...
	// +optional
	Tasks []v1alpha1.TaskSpec `json:"tasks,omitempty" protobuf:"bytes,3,opt,name=tasks"`
