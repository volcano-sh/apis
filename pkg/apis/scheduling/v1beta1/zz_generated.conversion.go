...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*PodsNetworkTopologySpec)(nil), (*scheduling.PodsNetworkTopologySpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_PodsNetworkTopologySpec_To_scheduling_PodsNetworkTopologySpec(a.(*PodsNetworkTopologySpec), b.(*scheduling.PodsNetworkTopologySpec), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*scheduling.PodsNetworkTopologySpec)(nil), (*PodsNetworkTopologySpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_scheduling_PodsNetworkTopologySpec_To_v1beta1_PodsNetworkTopologySpec(a.(*scheduling.PodsNetworkTopologySpec), b.(*PodsNetworkTopologySpec), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta1_PodGroupSpec_To_scheduling_PodGroupSpec(in *PodGroupSpec, out *scheduling.PodGroupSpec, s conversion.Scope) error {
	...
	out.PodsNetworkTopology = *(*[]scheduling.PodsNetworkTopologySpec)(unsafe.Pointer(&in.PodsNetworkTopology))
	return nil
}
...
func autoConvert_scheduling_PodGroupSpec_To_v1beta1_PodGroupSpec(in *scheduling.PodGroupSpec, out *PodGroupSpec, s conversion.Scope) error {
	...
	out.PodsNetworkTopology = *(*[]PodsNetworkTopologySpec)(unsafe.Pointer(&in.PodsNetworkTopology))
	return nil
}
...
func autoConvert_v1beta1_PodsNetworkTopologySpec_To_scheduling_PodsNetworkTopologySpec(in *PodsNetworkTopologySpec, out *scheduling.PodsNetworkTopologySpec, s conversion.Scope) error {
	out.NetworkTopology = (*scheduling.NetworkTopologySpec)(unsafe.Pointer(in.NetworkTopology))
	out.LabelMatch = (*metav1.LabelSelector)(unsafe.Pointer(in.LabelMatch))
	out.TaskName = (*string)(unsafe.Pointer(in.TaskName))
	return nil
}

// Convert_v1beta1_PodsNetworkTopologySpec_To_scheduling_PodsNetworkTopologySpec is an autogenerated conversion function.
func Convert_v1beta1_PodsNetworkTopologySpec_To_scheduling_PodsNetworkTopologySpec(in *PodsNetworkTopologySpec, out *scheduling.PodsNetworkTopologySpec, s conversion.Scope) error {
	return autoConvert_v1beta1_PodsNetworkTopologySpec_To_scheduling_PodsNetworkTopologySpec(in, out, s)
}

func autoConvert_scheduling_PodsNetworkTopologySpec_To_v1beta1_PodsNetworkTopologySpec(in *scheduling.PodsNetworkTopologySpec, out *PodsNetworkTopologySpec, s conversion.Scope) error {
	out.NetworkTopology = (*NetworkTopologySpec)(unsafe.Pointer(in.NetworkTopology))
	out.LabelMatch = (*metav1.LabelSelector)(unsafe.Pointer(in.LabelMatch))
	out.TaskName = (*string)(unsafe.Pointer(in.TaskName))
	return nil
...
// Convert_scheduling_PodsNetworkTopologySpec_To_v1beta1_PodsNetworkTopologySpec is an autogenerated conversion function.
func Convert_scheduling_PodsNetworkTopologySpec_To_v1beta1_PodsNetworkTopologySpec(in *scheduling.PodsNetworkTopologySpec, out *PodsNetworkTopologySpec, s conversion.Scope) error {
	return autoConvert_scheduling_PodsNetworkTopologySpec_To_v1beta1_PodsNetworkTopologySpec(in, out, s)
}
