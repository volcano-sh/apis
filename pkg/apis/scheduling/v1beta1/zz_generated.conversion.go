...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*PendingReasonInfo)(nil), (*scheduling.PendingReasonInfo)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_PendingReasonInfo_To_scheduling_PendingReasonInfo(a.(*PendingReasonInfo), b.(*scheduling.PendingReasonInfo), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*scheduling.PendingReasonInfo)(nil), (*PendingReasonInfo)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_scheduling_PendingReasonInfo_To_v1beta1_PendingReasonInfo(a.(*scheduling.PendingReasonInfo), b.(*PendingReasonInfo), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta1_PendingReasonInfo_To_scheduling_PendingReasonInfo(in *PendingReasonInfo, out *scheduling.PendingReasonInfo, s conversion.Scope) error {
...
// Convert_v1beta1_PendingReasonInfo_To_scheduling_PendingReasonInfo is an autogenerated conversion function.
func Convert_v1beta1_PendingReasonInfo_To_scheduling_PendingReasonInfo(in *PendingReasonInfo, out *scheduling.PendingReasonInfo, s conversion.Scope) error {
	return autoConvert_v1beta1_PendingReasonInfo_To_scheduling_PendingReasonInfo(in, out, s)
}

func autoConvert_scheduling_PendingReasonInfo_To_v1beta1_PendingReasonInfo(in *scheduling.PendingReasonInfo, out *PendingReasonInfo, s conversion.Scope) error {
	out.Action = in.Action
	out.Plugin = in.Plugin
...
// Convert_scheduling_PendingReasonInfo_To_v1beta1_PendingReasonInfo is an autogenerated conversion function.
func Convert_scheduling_PendingReasonInfo_To_v1beta1_PendingReasonInfo(in *scheduling.PendingReasonInfo, out *PendingReasonInfo, s conversion.Scope) error {
	return autoConvert_scheduling_PendingReasonInfo_To_v1beta1_PendingReasonInfo(in, out, s)
}
...
func autoConvert_v1beta1_PodGroupStatus_To_scheduling_PodGroupStatus(in *PodGroupStatus, out *scheduling.PodGroupStatus, s conversion.Scope) error {
	...
	if err := Convert_v1beta1_PendingReasonInfo_To_scheduling_PendingReasonInfo(&in.PendingReasonInfo, &out.PendingReasonInfo, s); err != nil {
		return err
	}
...
func autoConvert_scheduling_PodGroupStatus_To_v1beta1_PodGroupStatus(in *scheduling.PodGroupStatus, out *PodGroupStatus, s conversion.Scope) error {
	...
	if err := Convert_scheduling_PendingReasonInfo_To_v1beta1_PendingReasonInfo(&in.PendingReasonInfo, &out.PendingReasonInfo, s); err != nil {
		return err
	}
