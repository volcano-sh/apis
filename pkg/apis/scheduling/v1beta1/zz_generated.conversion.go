...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*NetworkTopologiesSpec)(nil), (*scheduling.NetworkTopologiesSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_NetworkTopologiesSpec_To_scheduling_NetworkTopologiesSpec(a.(*NetworkTopologiesSpec), b.(*scheduling.NetworkTopologiesSpec), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*scheduling.NetworkTopologiesSpec)(nil), (*NetworkTopologiesSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_scheduling_NetworkTopologiesSpec_To_v1beta1_NetworkTopologiesSpec(a.(*scheduling.NetworkTopologiesSpec), b.(*NetworkTopologiesSpec), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta1_NetworkTopologiesSpec_To_scheduling_NetworkTopologiesSpec(in *NetworkTopologiesSpec, out *scheduling.NetworkTopologiesSpec, s conversion.Scope) error {
	out.Mode = scheduling.NetworkTopologyMode(in.Mode)
	out.HighestTierAllowed = (*int)(unsafe.Pointer(in.HighestTierAllowed))
	return nil
}

// Convert_v1beta1_NetworkTopologiesSpec_To_scheduling_NetworkTopologiesSpec is an autogenerated conversion function.
func Convert_v1beta1_NetworkTopologiesSpec_To_scheduling_NetworkTopologiesSpec(in *NetworkTopologiesSpec, out *scheduling.NetworkTopologiesSpec, s conversion.Scope) error {
	return autoConvert_v1beta1_NetworkTopologiesSpec_To_scheduling_NetworkTopologiesSpec(in, out, s)
}

func autoConvert_scheduling_NetworkTopologiesSpec_To_v1beta1_NetworkTopologiesSpec(in *scheduling.NetworkTopologiesSpec, out *NetworkTopologiesSpec, s conversion.Scope) error {
	out.Mode = NetworkTopologyMode(in.Mode)
	out.HighestTierAllowed = (*int)(unsafe.Pointer(in.HighestTierAllowed))
	return nil
}

// Convert_scheduling_NetworkTopologiesSpec_To_v1beta1_NetworkTopologiesSpec is an autogenerated conversion function.
func Convert_scheduling_NetworkTopologiesSpec_To_v1beta1_NetworkTopologiesSpec(in *scheduling.NetworkTopologiesSpec, out *NetworkTopologiesSpec, s conversion.Scope) error {
	return autoConvert_scheduling_NetworkTopologiesSpec_To_v1beta1_NetworkTopologiesSpec(in, out, s)
}
...
func autoConvert_v1beta1_PodGroupSpec_To_scheduling_PodGroupSpec(in *PodGroupSpec, out *scheduling.PodGroupSpec, s conversion.Scope) error {
	...
	out.NetworkTopologies = (*scheduling.NetworkTopologiesSpec)(unsafe.Pointer(in.NetworkTopologies))
	return nil
}
...
func autoConvert_scheduling_PodGroupSpec_To_v1beta1_PodGroupSpec(in *scheduling.PodGroupSpec, out *PodGroupSpec, s conversion.Scope) error {
	...
	out.PriorityClassName = in.PriorityClassName
	out.MinResources = (*v1.ResourceList)(unsafe.Pointer(in.MinResources))
	out.NetworkTopologies = (*NetworkTopologiesSpec)(unsafe.Pointer(in.NetworkTopologies))
	return nil
}
