...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DependOns) DeepCopyInto(out *DependOns) {
	*out = *in
	if in.Targets != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DependOns.
func (in *DependOns) DeepCopy() *DependOns {
	if in == nil {
		return nil
	}
	out := new(DependOns)
...
func (in *TaskDependency) DeepCopyInto(out *TaskDependency) {
	*out = *in
	in.DependOns.DeepCopyInto(&out.DependOns)
	return
}
