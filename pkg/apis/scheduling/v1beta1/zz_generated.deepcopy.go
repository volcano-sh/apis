...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *QueueReservation) DeepCopyInto(out *QueueReservation) {
	*out = *in
	if in.Nodes != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new QueueReservation.
func (in *QueueReservation) DeepCopy() *QueueReservation {
	if in == nil {
		return nil
	}
	out := new(QueueReservation)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ReservationSpec) DeepCopyInto(out *ReservationSpec) {
	*out = *in
	if in.Tasks != nil {
		...
		*out = make([]v1alpha1.TaskSpec, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ReservationState) DeepCopyInto(out *ReservationState) {
	*out = *in
	in.LastTransitionTime.DeepCopyInto(&out.LastTransitionTime)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ReservationState.
func (in *ReservationState) DeepCopy() *ReservationState {
	if in == nil {
		return nil
	}
	out := new(ReservationState)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ReservationStatus) DeepCopyInto(out *ReservationStatus) {
	*out = *in
	...
	if in.TaskStatusCount != nil {
		...
		*out = make(map[string]v1alpha1.TaskState, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
