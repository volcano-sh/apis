...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NetworkTopologiesSpec) DeepCopyInto(out *NetworkTopologiesSpec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NetworkTopologiesSpec.
func (in *NetworkTopologiesSpec) DeepCopy() *NetworkTopologiesSpec {
	if in == nil {
		return nil
	}
	out := new(NetworkTopologiesSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PodGroupSpec) DeepCopyInto(out *PodGroupSpec) {
	*out = *in
	...
	if in.NetworkTopologies != nil {
		in, out := &in.NetworkTopologies, &out.NetworkTopologies
		*out = new(NetworkTopologiesSpec)
		(*in).DeepCopyInto(*out)
	}
	return
