...
func (in *PodGroupSpec) DeepCopyInto(out *PodGroupSpec) {
	*out = *in
	...
	if in.PodsNetworkTopology != nil {
		in, out := &in.PodsNetworkTopology, &out.PodsNetworkTopology
		*out = make([]PodsNetworkTopologySpec, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PodsNetworkTopologySpec) DeepCopyInto(out *PodsNetworkTopologySpec) {
	*out = *in
	if in.NetworkTopology != nil {
		in, out := &in.NetworkTopology, &out.NetworkTopology
		*out = new(NetworkTopologySpec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodsNetworkTopologySpec.
func (in *PodsNetworkTopologySpec) DeepCopy() *PodsNetworkTopologySpec {
	if in == nil {
		return nil
	}
	out := new(PodsNetworkTopologySpec)
	in.DeepCopyInto(out)
	return out
}
