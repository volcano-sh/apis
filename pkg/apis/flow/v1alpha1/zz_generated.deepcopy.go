...
func (in *DependsOn) DeepCopyInto(out *DependsOn) {
	*out = *in
	...
	if in.TargetsWithStatus != nil {
		in, out := &in.TargetsWithStatus, &out.TargetsWithStatus
...
func (in *JobFlowStatus) DeepCopyInto(out *JobFlowStatus) {
	*out = *in
	...
	out.State = in.State
	if in.FlowStatusMap != nil {
		in, out := &in.FlowStatusMap, &out.FlowStatusMap
		*out = make(map[string]batchv1alpha1.JobPhase, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
