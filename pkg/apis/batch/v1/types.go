...
type LifecyclePolicy struct {
	...
	// Default to None.
	// +optional
	Action busv1.Action `json:"action,omitempty" protobuf:"bytes,1,opt,name=action"`

	// The Event recorded by scheduler; the controller takes actions
	// according to this Event.
	// +optional
	Event busv1.Event `json:"event,omitempty" protobuf:"bytes,2,opt,name=event"`

	// The Events recorded by scheduler; the controller takes actions
	// according to this Events.
	// +optional
	Events []busv1.Event `json:"events,omitempty" protobuf:"bytes,3,opt,name=events"`
