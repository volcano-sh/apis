...
// TopologyV1alpha1Client is used to interact with features provided by the topology.volcano.sh group.
type TopologyV1alpha1Client struct {
	restClient rest.Interface
}

func (c *TopologyV1alpha1Client) HyperNodes() HyperNodeInterface {
	return newHyperNodes(c)
}
