...
type MemberSelectorApplyConfiguration struct {
	Type       *v1alpha1.MemberSelectorType  `json:"type,omitempty"`
...
func (b *MemberSelectorApplyConfiguration) WithType(value v1alpha1.MemberSelectorType) *MemberSelectorApplyConfiguration {
	b.Type = &value
	return b
}
