...
type ReservationStatusApplyConfiguration struct {
	...
	TaskStatusCount map[string]v1alpha1.TaskStateApplyConfiguration `json:"taskStatusCount,omitempty"`
...
func (b *ReservationStatusApplyConfiguration) WithTaskStatusCount(entries map[string]v1alpha1.TaskStateApplyConfiguration) *ReservationStatusApplyConfiguration {
	if b.TaskStatusCount == nil && len(entries) > 0 {
		b.TaskStatusCount = make(map[string]v1alpha1.TaskStateApplyConfiguration, len(entries))
	}
