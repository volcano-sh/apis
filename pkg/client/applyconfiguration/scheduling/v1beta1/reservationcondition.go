...
type ReservationConditionApplyConfiguration struct {
	Status             *schedulingv1beta1.ReservationPhase `json:"status,omitempty"`
...
func (b *ReservationConditionApplyConfiguration) WithStatus(value schedulingv1beta1.ReservationPhase) *ReservationConditionApplyConfiguration {
	b.Status = &value
	return b
}
...
func (b *ReservationConditionApplyConfiguration) WithLastTransitionTime(value v1.Time) *ReservationConditionApplyConfiguration {
