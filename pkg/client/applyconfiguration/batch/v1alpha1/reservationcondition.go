...
type ReservationConditionApplyConfiguration struct {
	Status             *batchv1alpha1.ReservationPhase `json:"status,omitempty"`
...
func (b *ReservationConditionApplyConfiguration) WithStatus(value batchv1alpha1.ReservationPhase) *ReservationConditionApplyConfiguration {
	b.Status = &value
	return b
}
