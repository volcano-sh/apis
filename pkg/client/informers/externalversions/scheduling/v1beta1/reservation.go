...
type ReservationInformer interface {
	...
	Lister() schedulingv1beta1.ReservationLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SchedulingV1beta1().Reservations(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SchedulingV1beta1().Reservations(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SchedulingV1beta1().Reservations(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SchedulingV1beta1().Reservations(namespace).Watch(ctx, options)
			},
		},
		&apisschedulingv1beta1.Reservation{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *reservationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisschedulingv1beta1.Reservation{}, f.defaultInformer)
}

func (f *reservationInformer) Lister() schedulingv1beta1.ReservationLister {
	return schedulingv1beta1.NewReservationLister(f.Informer().GetIndexer())
}
