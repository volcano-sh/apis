...
type ReservationInformer interface {
	...
	Lister() batchv1alpha1.ReservationLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.BatchV1alpha1().Reservations(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.BatchV1alpha1().Reservations(namespace).Watch(context.TODO(), options)
			},
		},
		&apisbatchv1alpha1.Reservation{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *reservationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisbatchv1alpha1.Reservation{}, f.defaultInformer)
}

func (f *reservationInformer) Lister() batchv1alpha1.ReservationLister {
	return batchv1alpha1.NewReservationLister(f.Informer().GetIndexer())
}
